    ...
    <main className="bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4 sm:px-5 py-6 sm:py-8">
          ...
          <Card className="mb-8 border-amber-200 bg-amber-50">
            <CardContent className="pt-6">
              <p className="text-amber-800">
                You don&apos;t have any permissions assigned yet. Please contact
                a super administrator to grant you access to admin features.
              </p>
            </CardContent>
          </Card>
        )}
        ...
        <div className="grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-8">
          {/* Total Orders - Only show if can view orders or analytics */}
          {(permissions.canViewOrders || permissions.canViewAnalytics) && (
          ...
          {/* Total Revenue - Only show if can view orders or analytics */}
          {(permissions.canViewOrders || permissions.canViewAnalytics) && (
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
          ...
          {/* Total Customers - Only show if can view customers */}
          {permissions.canViewCustomers && (
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
          ...
          {/* Today's Orders - Only show if can view orders */}
          {permissions.canViewOrders && (
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
          ...
          {/* Active Orders - Only show if can view orders */}
          {permissions.canViewOrders && (
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
          ...
          {/* Pending Orders - Only show if can view orders */}
          {permissions.canViewOrders && (
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
