  ...
  "inline-flex items-center justify-center rounded-full border px-2.5 py-1 text-xs font-semibold w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1.5 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-all duration-200 overflow-hidden",
  {
    variants: {
      variant: {
        ...
        outline:
          "text-foreground border-gray-300 bg-white [a&]:hover:bg-gray-50 [a&]:hover:border-gray-400 shadow-sm",
        success:
          "border-transparent bg-green-100 text-green-700 border-green-200 [a&]:hover:bg-green-200",
        warning:
          "border-transparent bg-amber-100 text-amber-700 border-amber-200 [a&]:hover:bg-amber-200",
        info:
          "border-transparent bg-blue-100 text-blue-700 border-blue-200 [a&]:hover:bg-blue-200",
      },
    },
    defaultVariants: {
      variant: "default",
